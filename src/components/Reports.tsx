...
export function Reports() {
  ...
  const generatePovertyProfileReport = () => {
        ...
        <div class="container">
          ...
          <div class="meta">
            ...
            <div class="meta-row">
              ...
              <span class="meta-value">CBMS System v1.0</span>
            </div>
          </div>
          ...
          <div class="signature-section">
            <div class="signature-box">
              <div class="signature-line">CBMS Focal Person</div>
          ...
          <div class="footer">
            <p><strong>Philippine Statistics Authority</strong> - Community-Based Monitoring System</p>
            <p class="highlight">This report contains confidential information protected under RA 10173 (Data Privacy Act of 2012)</p>
            <p>In compliance with Republic Act No. 11315 (CBMS Act)</p>
          </div>
        </div>
      </body>
      </html>
    ...
    link.setAttribute('download', `CBMS_${selectedReport}_${selectedBarangay}_${reportPeriod.replace(' ', '_')}.html`);
  ...
  const generateCSVReport = () => {
    ...
    link.setAttribute('href', url);
    link.setAttribute('download', `CBMS_Report_Data_${new Date().toISOString().split('T')[0]}.csv`);
    link.style.visibility = 'hidden';
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#143a63]/60 mt-1">Generate official CBMS reports for planning and compliance</p>
      </div>
              ...
              <div className="border border-[#e6e9ee] rounded-lg p-5 bg-[#f7f7f3]">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between py-2">
                    ...
                    <span className="font-semibold text-[#0a1c33]">CBMS System v1.0</span>
                  </div>
                </div>
